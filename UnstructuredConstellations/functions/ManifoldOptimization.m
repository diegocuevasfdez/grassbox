function [C,varargout] = ManifoldOptimization(C_initial,varargin)
...
%           Serbia, Aug. 2022, doi: 10.23919/EUSIPCO55093.2022.9909658.
%
...
[~, indices, separation,~,~] = MatrixDistances(C, opt_params.Distance);
...
for k = 1:opt_params.MaxIter
    ...
    while (~improvement) && h > opt_params.hfin
        ...
        [~, indicesnew, separation2, ~, ~] = MatrixDistances(Cnew, opt_params.Distance); % recompute minimum pairwise distance
